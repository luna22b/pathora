const AboutSection = () => {
  const Card = ({ children }) => (
    <div className="bg-white rounded-2xl w-full h-50 shadow-lg text-center pt-3 px-4">
      {children}
    </div>
  );

  return (
    <div className="bg-[#fcfcfc] py-16 mt-20">
        ...
        <div className="flex flex-col gap-6 text-left">
          ...
          <div className="flex flex-col gap-4 mt-4 text-[#333] lg:flex-row">
            <Card>
              ...
              <p className="pt-2">Take pictures</p>
            </Card>
            <Card>
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="pt-2">Explore plants</p>
            </Card>
            <Card>
              <svg
                xmlns="http://www.w3.org/2000/svg"
